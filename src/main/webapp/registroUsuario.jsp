...
<form name="accion" action="Login" method="post">
    <section>
        ...
        <div class="section">
            ...
            <div>
                <input class="box" type="text" name="usuario" placeholder="Usuario">
            </div>
        </div>
        <div class="section">
            <label>
            ...
            <div>
                <input class="box" type="text" name="contrasena" value="" placeholder="AuWhji34">
            </div>
        </div>
        ...
        <div class="section">
            ...
            <div>
                <input class="box" type="text" name="contrasena2" value="" placeholder="AuWhji34">
            </div>
        </div>
        ...
        <div class="section">
            ...
            <div>
                <input class="box" type="text" name="telefono" value="" placeholder="123456789">
            </div>
        </div>
        ...
        <button class="registro" name="accion" value="registroadmin" type="submit">REGISTRAR</button>
