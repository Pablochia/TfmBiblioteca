        ...
        <div class="table">
            <table>
                ...
                <tbody>
                    ...
                    for (Usuario u : busqueda.getUsuario(nombre)){
                	%>
                	
                    <tr>
                    	
	                        <td class="id" ><%= u.getId() %></td>
	                        <td class="usuario"><%= u.getNombre() %></td>
	                        <td class="contrasena"><%= u.getPassword() %></td>
	                        <td class="celda"><%= u.getTelefono() %></td>
	                        <td class="rol"><%= u.getRol() %></td>
	                        <td class="accion">
